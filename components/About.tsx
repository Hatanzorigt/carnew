  ...
  return (
    ...
    py-10 pb-32 lg:py-20'>
        ...
        <div className='w-full sm:w-2/3 flex flex-col relative center'>
          <div className='w-3/4'>
            ...
            <div className='pt-10'>
              ...
              <p>Car Care нь хэрэглэгчдэд авто машины бүх төрлийн үйлчилгээг хялбар хурдан авахад зориулагдсан гар утасны аппликейшн юм.</p>
            </div>
            <div className='pt-16'>
              <p className='bold-18'>“Рубик Эй Ай” ХХК</p>
              <p>2022 онд “Хиймэл оюун ухаан” хөгжүүлж хүний ажлыг хөнгөвчлөх систем бүтээх зорилготой Старт ап компани.</p>
              <br />
              <p> Авто машинтай хүн бүрд тулгардаг нийтлэг асуудлыг ухаалаг 
                гар утасны тусламжтай илүү хялбар шийдэх “Car Care” аппликейшн хөгжүүлэн ажиллаж байна.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="contact" className='bg-white pt-10 pb-10 center' style={{borderRadius: '40px' }}>
        <ul className="center gap-6 flex flex-col w-2/3 sm:w-full sm:flex-row sm:gap-8 lg:gap-10 justify-between px-5">
