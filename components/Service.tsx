...
const ServiceListFunc = () => {
  const items = [
    { text: 'Машиндаа тохирсон үйлчилгээ хаанаас авах вэ?', expanded: 'Car Care танд бүх авто машины үйлчилгээ эрхлэгчдийн байршил болон эрхэлдэг үйлчилгээг санал болгож байна.' },
    { text: 'Чанартай авто үйлчилгээний газар хэрхэн олох вэ?', expanded: 'Авто үйлчилгээ эрхлэгчдэд өгсөн хэрэглэгчдийн үнэлгээ болон сэтгэгдлийг харгалзан засвар үйлчилгээг сонгох боломжтой.' },
    { text: 'Хэдэн төгрөгөөр засах бол?', expanded: 'Авто үйлчилгээ эрхлэгчдийн үйлчилгээний үнэ ханшийг харьцуулан өөрт тохирох сонголтыг хийх боломжтой.' },
    ...
    <section id="services" className="2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 w-full px-3">
      ...
      <div className='flex flex-row pt-20 lg:pt-40'>
        <div className='max-container w-0 lg:w-1/2'>
          <Image src = "/utas_2.png" width={800} height={600} alt={''} quality={100}/>
        </div>
